...
source(file.path(repo_root, "src", "animations", "rendering.R"), chdir = TRUE)
source(file.path(repo_root, "src", "animations", "solver_convergence.R"), chdir = TRUE)
source(file.path(repo_root, "src", "animations", "control_canvas.R"), chdir = TRUE)
