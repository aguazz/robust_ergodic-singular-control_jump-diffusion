# Sweeps, misspecification grids, and paper-figure experiment helpers.
# Source split from legacy/functions_solver_and_images.R; functions only, no long runs at source time.
